...
\NewPart{Education}
\begin{itemize}
\item \textbf{B.S. in Computer Engineering} \date{\begin{flushleft}\today\end{flushleft}} \hfill Sep 2017 - Jul 2021(Expected) \newline
\small  University of Guilan \newline
\small GPA: 18.16/20 
...
$\cdot$ \footnotesize I designed some of assignments and final project of course.The project was about using A* algorithm to play a game.
...
\textbf{Reinforcement Learning;A survey} \newline
\textbf{Best courses of Reinforcement Learning} \newline
\textbf{AI learning path} \newline
\textbf{Introduction to Pytorch} \newline
\textbf{DDOS attacks}
